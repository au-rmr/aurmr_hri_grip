          ...
          {window.exp('streamlined') ? (
            <Card>
              <CardContent>
                ...
                <Button onClick={() => this.handleRegraspClick('fail_wrong_item')} style={{fontWeight: 'bold'}} size="large" color="error" variant="contained">Wrong Item</Button>
                <Button onClick={() => this.handleRegraspClick('fail_ignore')} style={{fontWeight: 'bold'}} size="large" color="error" variant="contained">Ignore</Button>
                <Button onClick={() => {
                  this.sendDone()
                  this.sendRecordEvent({
                    event_type: 'pick_eval',
            ...
            <Card sx={targetModalStyle}>
              ...
              />
                ...
                <Typography sx={{ mt: 2 }}>
                  ...
                  &nbsp;
                  <Button onClick={() => this.setState({selectingTarget: false, selectedTarget: null})} variant="contained" size="small" color="error">Cancel</Button>
                  <div className='targetSelectModal-arrows'>
                    <ArrowDropUpIcon onClick={() => this.executeCropAdjustment('up')} />
                    <ArrowLeftIcon onClick={() => this.executeCropAdjustment('left')} />
                    <ArrowRightIcon onClick={() => this.executeCropAdjustment('right')} />
                    <ArrowDropDownIcon onClick={() => this.executeCropAdjustment('down')} />
                  </div>
                </Typography>
          <div>
        </div>
